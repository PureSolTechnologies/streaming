...
/**
 * This class provides an TSV writer. The default settings write toe the
 * provided stream as RFC4180 (https://tools.ietf.org/html/rfc4180) compliant
 * file. The only change is that separation of columns is done with tabs '\t'.
 *
...
public class TSVWriter {
    ...
    public TSVWriter(OutputStream outputStream, Charset charset) {
	this.outputStream = outputStream;
	this.charset = charset;
    }

    public void writeHeader(TSVHeader header) throws IOException {
