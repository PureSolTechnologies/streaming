 ...
 * class is converting into LittleEndian encoding (Intel format).
 * 
 * @author Rick-Rainer Ludwig
 *
 */
public final class LittleEndianBytes extends AbstractBytes {
	...
	bytes[offset] = (byte) (l);
	bytes[offset + 1] = (byte) (l >>> 8);
	bytes[offset + 2] = (byte) (l >>> 16);
	bytes[offset + 3] = (byte) (l >>> 24);
	bytes[offset + 4] = (byte) (l >>> 32);
	bytes[offset + 5] = (byte) (l >>> 40);
	bytes[offset + 6] = (byte) (l >>> 48);
	bytes[offset + 7] = (byte) (l >>> 56);
	return 8;
    }
